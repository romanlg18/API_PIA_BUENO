...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-04-2023 a las 22:11:46
...
INSERT INTO `args_clientes` (`IdCliente`, `CL_NOMBRES`, `CL_APELLIDOS`, `CL_Numero`, `CL_Correo`, `IDSEGUROS`, `SEGURO_INT`) VALUES
(1, 'Roman ', 'Leyva Garza', 8120741152, 'roman.leyvagrz@uanl.edu.mx', 3, ''),
(2, 'Daniela Alejandra', 'Vieyra Caballero', 8120741154, 'daniela@uanl.edu.mx', 2, ''),
(3, 'Alder Adad', 'Portillo Silva', 8120741155, 'alder@uanl.edu.mx', 1, ''),
(5, 'Román', 'Leyva Garza', 8120741152, 'romanleyva269@gmail.com', 3, 'Seguro de Retiro');
...
(1, 'Seguro de Gastos Médicos', 'Te protege a ti y tus seres queridos ante el ', 1),
...
--
ALTER TABLE `args_seguros`
  MODIFY `IDSEGUROS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
